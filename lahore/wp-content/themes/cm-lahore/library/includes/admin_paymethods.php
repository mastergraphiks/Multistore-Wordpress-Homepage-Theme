...
if($paymentinfo)
{
	...
	{
		echo '<a href="'.get_option( 'siteurl' ).'/admin/admin.php?page=paymentoptions&status=0&id='.$option_id.'">Deactivate</a>';
	}else
	{
		echo '<a href="'.get_option( 'siteurl' ).'/admin/admin.php?page=paymentoptions&status=1&id='.$option_id.'">Activate</a>';
	}
	?></td>
      <td><?php
    echo '<a href="'.get_option( 'siteurl' ).'/admin/admin.php?page=paymentoptions&payact=setting&id='.$option_id.'">Settings</a>';
	?></td>
      <td>&nbsp;</td>
    </tr>
    <?php
