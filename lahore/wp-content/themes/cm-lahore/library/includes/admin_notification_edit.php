...
if($_POST)
{
	...
	if($file=='emails' || $file=='message')
	{
		...
		wp_redirect(get_option('siteurl').'/admin/admin.php?page=notification&msg=success');
	}
}
?>
<style>
...
if($file_array)
{
  ...
  <tr>
  <td></td>
  <td><input type="submit" name="Submit" value="Submit"> <input type="button" name="cancel" value="Cancel" onClick="window.location.href='<?php echo get_option('siteurl');?>/admin/admin.php?page=notification'">
  <input type="button" name="cancel" value="Back" onClick="window.location.href='<?php echo get_option('siteurl');?>/admin/admin.php?page=notification'">
  </td>
  </tr>
</table>
</form>
