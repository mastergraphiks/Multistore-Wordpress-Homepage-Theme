...
function postform()
{
	...
	$.ajax({
		...
		success: function(html){
			...
			{
				document.getElementById('addtocartformspan').innerHTML = '<strong><?php _e('Added in Cart');?><Br><a href="<?php echo get_option('siteurl'); ?>/?page=cart"><?php _e('View Cart Detail');?></a> or <a href="<?php echo get_option('siteurl'); ?>/?page=cart"><?php _e('Checkout &raquo;');?> &raquo;</a></strong>';
...
{
?>
  <div class="b_addtocart" id="shoppingcart_button_1"><a href="javascript:void(0);" onclick="setAttributeVal();"> <?php _e("Add to Shopping Cart");?> &raquo;  </a></div>
