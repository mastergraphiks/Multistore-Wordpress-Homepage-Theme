...
?>
    <tr>
      <td><a href="<?php echo get_option('siteurl');?>/admin/admin.php?page=notification&notification=emails&file=<?php echo $email_file_array[$e]['file'];?>"><?php echo $email_file_array[$e]['file'];?></a></td>
...
?>
    <tr>
      <td><a href="<?php echo get_option('siteurl');?>/admin/admin.php?page=notification&notification=message&file=<?php echo $message_file_array[$e]['file'];?>"><?php echo $message_file_array[$e]['file'];?></a></td>
