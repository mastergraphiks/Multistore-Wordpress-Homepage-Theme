...
<div class="myorders ">
     <div class="myorders_col myorders_col_2 fl">
        ...
        <input type="password" name="cnew_passwd" id="cnew_passwd"  class="myorder_text" />
          <input type="submit" name="Update" value="<?php _e('Update') ?>" class="highlight_input_btn fr" onclick="return chk_form_pw();" />
...
<form name="registerform" id="registerform" action="<?php echo get_option( 'siteurl' ).'/?page=myaccount&type=editprofile'; ?>" method="post">
  ...
  <div class="myorders ">
    ...
    <div class="myorders_col fr">
      ...
      <p><input type="checkbox" class="checkin" name="copybilladd" id="copybilladd" onClick="copy_billing_address();" > same as <?php _e(USER_INFO_TEXT);?></p>
      <div class="myorder_form_row ">
        <label>
        <?php _e('First Name') ?>
        </label>
