...
add_contextual_help($current_screen,
	...
	'<p>' . __('Once you add this code and refresh your browser, multisite should be enabled. This screen will keep an archive of the added code. You can toggle between Network Admin and Site Admin by clicking on the DesignerClub (Username) dropdown in the upper right of the administration area.') . '</p>' .
    ...
    <system.webServer>
        <rewrite>
            <rules>
                ...
                <rule name="WordPress Rule 3" stopProcessing="true">
                    <match url="^([_0-9a-zA-Z-]+/)?admin$" ignoreCase="false" />
                    <action type="Redirect" url="{R:1}admin/" redirectType="Permanent" />
                </rule>
                <rule name="WordPress Rule 4" stopProcessing="true">
                    <match url="^" ignoreCase="false" />
                    <conditions logicalGrouping="MatchAny">
