...
/**
 * @package Adminimize
 * @subpackage Designer Club Options
 * @author Frank Bültge
 */
...
?>
		...
		<div id="poststuff" class="ui-sortable meta-box-sortables">
			<div class="postbox">
				...
				<h3 class="hndle" id="dashboard_options"><?php _e('Designer Club options', FB_ADMINIMIZE_TEXTDOMAIN ); ?></h3>
				<div class="inside">
					<br class="clear" />
						<?php
							// get widgets
							...
							if ( ! isset( $widgets ) ) {
								...
								_e( 'To complete the installation for Designer Club Widgets you must visit your dashboard once and then come back to Settings > Adminimize to configure who has access to each widget.', FB_ADMINIMIZE_TEXTDOMAIN );
								echo '</p>';
							} else {
						?>
