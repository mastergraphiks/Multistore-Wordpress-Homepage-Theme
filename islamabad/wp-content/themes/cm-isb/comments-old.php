    ...
    <?php else : ?>
        ...
        <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
            ...
            <?php if ( $user_ID ) : ?>
                ...
                <p><?php echo get_option('ptthemes_comment_loggedin_name'); ?> &rarr; <a href="<?php echo get_option('siteurl'); ?>/admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?action=logout" title="Log out of this account"><?php echo get_option('ptthemes_comment_logout_name'); ?> &raquo;</a></p>
