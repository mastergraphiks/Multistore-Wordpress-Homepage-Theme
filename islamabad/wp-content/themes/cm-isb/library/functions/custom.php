...
if($_GET['ptype']=='prd' || $_POST || $editproduct==1){
	...
	array(
		...
		"type" 		=> "text",
		"tabindex"	=>	'2',
		"description" => "Enter Product Original Price (price is in PKR(Rs)).");
	...
	array(
		...
		"default" 	=> "0.00",
		"tabindex"	=>	'2',
		"description" => "Enter Special Price to be display (price is in PKR(Rs)).");
	...
	array(
		...
		"default" 	=> "",
		"tabindex"	=>	'2',
		"description" => "For this particular product, if you want to disable your shopping cart and want to take your visitor to some other website (for example an affiliate link to Amazon.com), mention the full URL here with necessary html tags will appear on your site that will take the user to new site. <br><b>example</b> &lt;a href=&quot;http://www.amazon.com&quot; class=&quot;normal_button fl&quot; &gt; My Link Title here &lt;/a&gt;");
...
<table border="0" cellspacing="8" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center"><a href="<?php echo get_option( 'siteurl' ) ."/admin/edit.php?ptype=prd&month=$currentmonth";?>"><?php echo $General->get_total_products(date('m'));?></a></td>
    <td align="center"><a href="<?php echo get_option( 'siteurl' ) ."/admin/edit.php?ptype=prd";?>"><?php echo $General->get_total_products();?></a></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td width="25%">Total Orders</td>
    <td align="center"><?php if($totalOrders){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&month=$currentmonth";?>">
      <?php }?>
    ...
    <td align="center"><?php if($totalOrders_currenmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders";?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($processingOrders_currentmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&month=$currentmonth&srch_status=processing";?>">
      <?php }?>
    ...
    <td align="center"><?php if($processingOrders){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&srch_status=processing";?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($approveOrders_currentmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&month=$currentmonth&srch_status=approve";?>">
      <?php }?>
      ...
      <?php }?></td>
    <td align="center"><?php if($approveOrders_currentmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&srch_status=approve";?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($rejectOrders_currentmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&month=$currentmonth&srch_status=reject";?>">
      <?php }?>
    ...
    <td align="center"><?php if($rejectOrders){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&srch_status=reject";?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($cancelOrders_currentmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&month=$currentmonth&srch_status=cancel";?>">
      <?php }?>
    ...
    <td align="center"><?php if($cancelOrders){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&srch_status=cancel";?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($shippingOrders_currentmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&month=$currentmonth&srch_status=shipping";?>">
      <?php }?>
    ...
    <td align="center"><?php if($shippingOrders){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&srch_status=shipping";?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($deliveredOrders_currentmonth){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&month=$currentmonth&srch_status=delivered";?>">
      <?php }?>
    ...
    <td align="center"><?php if($deliveredOrders){?>
      <a href="<?php echo get_option( 'siteurl' ) ."/admin/admin.php?page=manageorders&srch_status=delivered";?>">
      <?php }?>
...
?>
  <tr>
    <td ><a href="<?php echo get_option('siteurl');?>/admin/admin.php?page=manageorders&oid=<?php echo $orders_array[$o]['order_id'];?>"><?php echo $orders_array[$o]['order_id'];?></a></td>
