...
if($_REQUEST['pagetype'] == 'delete' && $_REQUEST['code'] != '')
{
	...
	$location = get_option('siteurl')."/admin/admin.php?page=managecoupon&msg=delsuccess";
...
<?php }?>
<p><a href="<?php echo get_option('siteurl').'/admin/admin.php?page=managecoupon&pagetype=addedit'?>"><strong><?php _e('Add Coupon'); ?></strong></a> </p>
...
?>
    <tr>
      ...
      <td><a href="<?php echo get_option('siteurl').'/admin/admin.php?page=managecoupon&pagetype=addedit&code='.$key;?>"><?php _e('Edit'); ?></a> </td>
      <td><a href="<?php echo get_option('siteurl').'/admin/admin.php?page=managecoupon&pagetype=delete&code='.$key;?>"><?php _e('Delete'); ?></a></td>
      <td>&nbsp;</td>
    </tr>
    <?php
		}
