      ...
      <div id="checkout_sidebar">
        ...
        <div class="checkout_address">
          <div class="address_info fl">
            <h3><?php _e(BILLING_ADDRESS_TEXT); ?> <span>(<a href="<?php echo get_option('siteurl'); ?>/?page=myaccount&type=editprofile"><u><?php _e('Edit'); ?></u></a>)</span> </h3>
          ...
          <div class="address_info fr">
            <h3><?php _e(SHIPPING_ADDRESS_TEXT); ?> <span>(<a href="<?php echo get_option('siteurl'); ?>/?page=myaccount&type=editprofile"><u><?php _e('Edit'); ?></u></a>)</span> </h3>
