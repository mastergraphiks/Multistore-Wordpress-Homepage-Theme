...
<table width="100%">
<tr>
<td><form method="post" action="<?php echo get_option('siteurl');?>/admin/admin.php?page=stock" name="stock_frm">
<?php
...
<table width="100%" cellpadding="5" class="widefat post fixed" >
  <thead>
    <tr>
      <th width="350" align="left"><strong><?php _e('Posts'); ?></strong></th>
...
if($prdinfo)
{
	...
	?>
    <tr class="stock">
      <td><a href="<?php echo get_option('siteurl');?>/admin/post.php?action=edit&post=<?php echo $prdinfo[$i]->ID;?>"><div><?php echo $prdinfo[$i]->post_title;?></div></a></td>
      <td align="center"><?php
		if($data['initstock']=='')
		{
			echo "Unlimited";
