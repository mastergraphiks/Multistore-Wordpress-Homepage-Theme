...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'utils', "/admin/js/utils$suffix.js", false, '20101110' );

	$scripts->add( 'common', "/admin/js/common$suffix.js", array('jquery', 'hoverIntent', 'utils'), '20110610' );
	...
	$scripts->add( 'editor', "/admin/js/editor$suffix.js", array('utils','jquery'), '20110411' );
	$scripts->add_data( 'editor', 'group', 1 );

	$scripts->add( 'wp-fullscreen', "/admin/js/wp-fullscreen$suffix.js", array('jquery'), '20110704' );
	...
	$scripts->add( 'password-strength-meter', "/admin/js/password-strength-meter$suffix.js", array('jquery'), '20101027' );
	...
	$scripts->add( 'user-profile', "/admin/js/user-profile$suffix.js", array( 'jquery', 'password-strength-meter' ), '20110628' );
	...
	if ( is_admin() ) {
		$scripts->add( 'ajaxcat', "/admin/js/cat$suffix.js", array( 'wp-lists' ), '20090102' );
		...
		$scripts->add( 'admin-categories', "/admin/js/categories$suffix.js", array('wp-lists'), '20091201' );
		$scripts->add_data( 'admin-categories', 'group', 1 );

		$scripts->add( 'admin-tags', "/admin/js/tags$suffix.js", array('jquery', 'wp-ajax-response'), '20110429' );
		...
		$scripts->add( 'admin-custom-fields', "/admin/js/custom-fields$suffix.js", array('wp-lists'), '20110429' );
		$scripts->add_data( 'admin-custom-fields', 'group', 1 );

		$scripts->add( 'admin-comments', "/admin/js/edit-comments$suffix.js", array('wp-lists', 'jquery-ui-resizable', 'quicktags', 'jquery-query'), '20110602' );
		...
		$scripts->add( 'xfn', "/admin/js/xfn$suffix.js", array('jquery'), '20110524' );
		$scripts->add_data( 'xfn', 'group', 1 );

		$scripts->add( 'postbox', "/admin/js/postbox$suffix.js", array('jquery-ui-sortable'), '20110612' );
		$scripts->add_data( 'postbox', 'group', 1 );

		$scripts->add( 'post', "/admin/js/post$suffix.js", array('suggest', 'wp-lists', 'postbox'), '20110524' );
		...
		$scripts->add( 'link', "/admin/js/link$suffix.js", array('wp-lists', 'postbox'), '20110524' );
		$scripts->add_data( 'link', 'group', 1 );

		$scripts->add( 'comment', "/admin/js/comment$suffix.js", array('jquery'), '20110429' );
		...
		$scripts->add( 'admin-gallery', "/admin/js/gallery$suffix.js", array( 'jquery-ui-sortable' ), '20110414' );

		$scripts->add( 'media-upload', "/admin/js/media-upload$suffix.js", array( 'thickbox' ), '20110425' );
		$scripts->add_data( 'media-upload', 'group', 1 );

		$scripts->add( 'admin-widgets', "/admin/js/widgets$suffix.js", array( 'jquery-ui-sortable', 'jquery-ui-draggable', 'jquery-ui-droppable' ), '20110601' );
		$scripts->add_data( 'admin-widgets', 'group', 1 );

		$scripts->add( 'word-count', "/admin/js/word-count$suffix.js", array( 'jquery' ), '20110515' );
		$scripts->add_data( 'word-count', 'group', 1 );

		$scripts->add( 'theme', "/admin/js/theme$suffix.js", array( 'thickbox' ), '20110118' );
		$scripts->add_data( 'theme', 'group', 1 );

		$scripts->add( 'theme-preview', "/admin/js/theme-preview$suffix.js", array( 'thickbox', 'jquery' ), '20100407' );
		$scripts->add_data( 'theme-preview', 'group', 1 );

		$scripts->add( 'inline-edit-post', "/admin/js/inline-edit-post$suffix.js", array( 'jquery', 'suggest' ), '20110609' );
		...
		$scripts->add( 'inline-edit-tax', "/admin/js/inline-edit-tax$suffix.js", array( 'jquery' ), '20110609' );
		...
		$scripts->add( 'plugin-install', "/admin/js/plugin-install$suffix.js", array( 'jquery', 'thickbox' ), '20110113' );
		...
		$scripts->add( 'dashboard', "/admin/js/dashboard$suffix.js", array( 'jquery', 'admin-comments', 'postbox' ), '20110524' );
		...
		$scripts->add( 'media', "/admin/js/media$suffix.js", array( 'jquery-ui-draggable' ), '20101022' );
		$scripts->add_data( 'media', 'group', 1 );

		$scripts->add( 'image-edit', "/admin/js/image-edit$suffix.js", array('jquery', 'json2', 'imgareaselect'), '20110524' );
		$scripts->add_data( 'image-edit', 'group', 1 );

		$scripts->add( 'set-post-thumbnail', "/admin/js/set-post-thumbnail$suffix.js", array( 'jquery' ), '20100518' );
		...
		// Navigation Menus
		$scripts->add( 'nav-menu', "/admin/js/nav-menu$suffix.js", array('jquery-ui-sortable'), '20110524' );
		...
		$scripts->add( 'custom-background', "/admin/js/custom-background$suffix.js", array('farbtastic'), '20110511' );
...
function wp_default_styles( &$styles ) {
	...
	$styles->default_dirs = array('/admin/');

	$suffix = defined('SCRIPT_DEBUG') && SCRIPT_DEBUG ? '.dev' : '';

	$rtl_styles = array( 'admin', 'global', 'colors', 'colors-fresh', 'colors-classic', 'dashboard', 'ie', 'install', 'login', 'media', 'theme-editor', 'upload', 'widgets', 'press-this', 'plugin-install', 'nav-menu', 'farbtastic', 'admin-bar', 'wplink', 'theme-install' );
	// Any rtl stylesheets that don't have a .dev version for ltr
	$no_suffix = array( 'farbtastic' );

	$styles->add( 'admin', "/admin/css/admin$suffix.css", array(), '20110711' );

	$styles->add( 'ie', "/admin/css/ie$suffix.css", array(), '20110711' );
	...
	$styles->add( 'colors-fresh', "/admin/css/colors-fresh$suffix.css", array(), $colors_version );
	$styles->add( 'colors-classic', "/admin/css/colors-classic$suffix.css", array(), $colors_version );

	$styles->add( 'ms', "/admin/css/ms$suffix.css", array(), '20110623' );
	$styles->add( 'global', "/admin/css/global$suffix.css", array(), '20110711b' );
	$styles->add( 'media', "/admin/css/media$suffix.css", array(), '20110707' );
	$styles->add( 'widgets', "/admin/css/widgets$suffix.css", array(), '20110606' );
	$styles->add( 'dashboard', "/admin/css/dashboard$suffix.css", array(), '20110711' );
	$styles->add( 'install', "/admin/css/install$suffix.css", array(), '20110707' ); // Readme as well
	$styles->add( 'theme-editor', "/admin/css/theme-editor$suffix.css", array(), '20110602' );
	$styles->add( 'press-this', "/admin/css/press-this$suffix.css", array(), '20110707' );
	$styles->add( 'thickbox', '/wp-includes/js/thickbox/thickbox.css', array(), '20090514' );
	$styles->add( 'login', "/admin/css/login$suffix.css", array(), '20110610' );
	$styles->add( 'plugin-install', "/admin/css/plugin-install$suffix.css", array(), '20110628' );
	$styles->add( 'theme-install', "/admin/css/theme-install$suffix.css", array(), '20110506' );
	$styles->add( 'farbtastic', '/admin/css/farbtastic.css', array(), '1.3u' );
	$styles->add( 'jcrop', '/wp-includes/js/jcrop/jquery.Jcrop.css', array(), '0.9.8' );
	$styles->add( 'imgareaselect', '/wp-includes/js/imgareaselect/imgareaselect.css', array(), '0.9.1' );
	$styles->add( 'nav-menu', "/admin/css/nav-menu$suffix.css", array(), '20110611' );
...
function _print_scripts() {
	...
	if ( !empty($wp_scripts->concat) ) {
		...
		$src = $wp_scripts->base_url . "/admin/load-scripts.php?c={$zip}&load=" . trim($wp_scripts->concat, ', ') . "&ver=$ver";
...
function print_admin_styles() {
	...
	if ( apply_filters('print_admin_styles', true) ) {
		if ( !empty($wp_styles->concat) ) {
			...
			$href = $wp_styles->base_url . "/admin/load-styles.php?c={$zip}&dir={$dir}&load=" . trim($wp_styles->concat, ', ') . "&ver=$ver";
