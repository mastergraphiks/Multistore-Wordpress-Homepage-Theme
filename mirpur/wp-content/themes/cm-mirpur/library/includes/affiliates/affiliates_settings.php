...
if($_REQUEST['user_id']=='')
{
	...
	?>
	<form action="<?php echo get_option( 'siteurl' );?>/admin/admin.php?page=affiliates_settings" method="post">
     <input type="hidden" name="setsetting" value="1" />
	<style>
