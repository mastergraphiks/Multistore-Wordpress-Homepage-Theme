...
/**
 * Core Upgrader class for WordPress. It allows for WordPress to upgrade itself in combiantion with the admin/includes/update-core.php file
 *
 * @TODO More Detailed docs, for methods as well.
 *
 * @package WordPress
...
class Core_Upgrader extends WP_Upgrader {
	...
	function upgrade($current) {
		...
		require(ABSPATH . 'admin/includes/update-core.php');
