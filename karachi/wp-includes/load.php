 ...
 * admin/setup-config.php. We must globalize $wpdb to ensure that it is
...
/**
 * Whether the current request is for a blog admin screen /admin/
 *
...
/**
 * Whether the current request is for a network admin screen /admin/network/
 *
...
/**
 * Whether the current request is for a user admin screen /admin/user/
 *
 * Does not inform on whether the user is an admin! Use capability checks to
 * tell if the user should be accessing a section or not.
 *
