					...
					<table summary="config" class="widefat">
						<tbody>
							...
							if ( '' != $disabled_menu_all ) {
								...
								?>
								<tr valign="top" class="form-invalid">
									<td><?php _e('Designer Club deactivate, redirect to', FB_ADMINIMIZE_TEXTDOMAIN ); ?></td>
									<td>
										...
										<br /><?php _e('You have deactivated the Designer Club, please select a page for redirection or define custom url, include http://?', FB_ADMINIMIZE_TEXTDOMAIN ); ?>
									</td>
								</tr>
								<?php
							}
