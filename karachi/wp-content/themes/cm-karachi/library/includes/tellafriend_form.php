...
.textfield { border:1px solid #ccc; padding:3px; font-size:12px; width:380px; }
.textarea { border:1px solid #ccc; padding:3px; font:12px Arial, Helvetica, sans-serif; width:400px; height:250px; }
...
a.close { position:absolute; right:0px; top:0px; padding:5px 8px; background:#333; color:#fff; -moz-border-radius:5px; -webkit-border-radius:5px; cursor:pointer; font:bold 14px Arial, Helvetica, sans-serif; text-decoration:none; display:block }
