...
<?php }?>
<form action="<?php get_option( 'siteurl' ).'/admin/admin.php?page=manageshipping';?>" method="post" name="shippingfrm">
...
?>
	...
	{
		echo '<a href="'.get_option( 'siteurl' ).'/admin/admin.php?page=manageshipping&payact=setting&id='.$option_id.'">Settings</a>';
	}else
	{
		echo "Settings";
	}
